      ...
      <div className="bg-cyan-100 p-6 rounded-lg">
        <h2 className="text-3xl font-semibold text-gray-600">Your Order</h2>
          <div>
            ...
            <div className="flex items-center gap-6 bg-white rounded-md p-2 text-cyan-700">
            ...
            <div className='bg-cyan-700 text-center py-3 text-md font-semibold text-white rounded-lg transition duration-300 hover:bg-cyan-500'>
                <Link>Order Now</Link>
            </div>
      </div>
    );
